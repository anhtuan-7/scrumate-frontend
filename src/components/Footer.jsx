...
const Footer = () => {
  return (
    <footer className="bg-white backdrop-saturate-200 backdrop-blur-2xl bg-opacity-80 text-blue-gray-900 w-full grid md:grid-cols-3 gap-4 items-center justify-items-center py-6 px-10 border-t mt-4">
